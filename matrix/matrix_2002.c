    ...
    for (i = 1; i < nArgNum; i++ )
    {
        CHECK_POINTER(strInput[i], ZZ_ERR_NULL_PTR);
        {
            ...
            else if (0 == zz_strcmp(strInput[i], ZZ_STRING("--hdr-input")))
            {
                ...
                ZZPRINTF("[M2002] hdr-input: display_primaries_x[0] = %d\n", pParams->hdr_input.display_primaries_x[0]);
                ZZPRINTF("[M2002] hdr-input: display_primaries_x[1] = %d\n", pParams->hdr_input.display_primaries_x[1]);
                ZZPRINTF("[M2002] hdr-input: display_primaries_x[2] = %d\n", pParams->hdr_input.display_primaries_x[2]);
                ZZPRINTF("[M2002] hdr-input: display_primaries_y[0] = %d\n", pParams->hdr_input.display_primaries_y[0]);
                ZZPRINTF("[M2002] hdr-input: display_primaries_y[1] = %d\n", pParams->hdr_input.display_primaries_y[1]);
                ZZPRINTF("[M2002] hdr-input: display_primaries_y[2] = %d\n", pParams->hdr_input.display_primaries_y[2]);
                ZZPRINTF("[M2002] hdr-input: white_point_x = %d\n", pParams->hdr_input.white_point_x);
                ZZPRINTF("[M2002] hdr-input: white_point_y = %d\n", pParams->hdr_input.white_point_y);
                ZZPRINTF("[M2002] hdr-input: max_display_mastering_luminance = %d\n", pParams->hdr_input.max_display_mastering_luminance);
                ZZPRINTF("[M2002] hdr-input: min_display_mastering_luminance = %d\n", pParams->hdr_input.min_display_mastering_luminance);
                ZZPRINTF("[M2002] hdr-input: max_content_light_level     = %d\n", pParams->hdr_input.max_content_light_level);
                ZZPRINTF("[M2002] hdr-input: max_pic_average_light_level = %d\n", pParams->hdr_input.max_pic_average_light_level);
            ...
            else if (0 == zz_strcmp(strInput[i], ZZ_STRING("--hdr-output")))
            {
                ...
                ZZPRINTF("[M2002] hdr-output display_primaries_x[0] = %d\n", pParams->hdr_output.display_primaries_x[0]);
                ZZPRINTF("[M2002] hdr-output display_primaries_x[1] = %d\n", pParams->hdr_output.display_primaries_x[1]);
                ZZPRINTF("[M2002] hdr-output display_primaries_x[2] = %d\n", pParams->hdr_output.display_primaries_x[2]);
                ZZPRINTF("[M2002] hdr-output display_primaries_y[0] = %d\n", pParams->hdr_output.display_primaries_y[0]);
                ZZPRINTF("[M2002] hdr-output display_primaries_y[1] = %d\n", pParams->hdr_output.display_primaries_y[1]);
                ZZPRINTF("[M2002] hdr-output display_primaries_y[2] = %d\n", pParams->hdr_output.display_primaries_y[2]);
                ZZPRINTF("[M2002] hdr-output white_point_x = %d\n", pParams->hdr_output.white_point_x);
                ZZPRINTF("[M2002] hdr-output white_point_y = %d\n", pParams->hdr_output.white_point_y);
                ZZPRINTF("[M2002] hdr-output max_display_mastering_luminance = %d\n", pParams->hdr_output.max_display_mastering_luminance);
                ZZPRINTF("[M2002] hdr-output min_display_mastering_luminance = %d\n", pParams->hdr_output.min_display_mastering_luminance);
                ZZPRINTF("[M2002] hdr-output max_content_light_level     = %d\n", pParams->hdr_output.max_content_light_level);
                ZZPRINTF("[M2002] hdr-output max_pic_average_light_level = %d\n", pParams->hdr_output.max_pic_average_light_level);
            }
        }
    }
