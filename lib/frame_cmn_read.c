...
static zzStatus ZZ_LoadNext_A2RGB10(zzFrameData* pData, zzFrameInfo* pInfo, zz_file*  fSrc);
...
static struct zzFrameReadMap
{
    ...
    {ZZ_FOURCC_A2RGB10,     ZZ_LoadNext_A2RGB10},
...
zzStatus ZZ_LoadNext_A2RGB10(zzFrameData* pData, zzFrameInfo* pInfo, zz_file*  fSrc)
{
    zzU32  w, h, i, pitch;
    zzU32  nBytesRead;
    zzU8  *ptr;
